...
OilConnection.prototype.connect = function(cb) {
  if (this.mysqlConnection) {
    ...
    if (!('database' in this.connectionOptions) && 'db' in this.connectionOptions) {
      this.connectionOptions.database = this.connectionOptions.db;
      delete this.connectionOptions.db;
    }
